...
def compile_to_json(filepath):
    ...
    return {'fstDoculects': json_fst_doculects, 'fstUp': json_fst_up, 'fstDown': json_fst_down, 'words': json_words, 'syllables': json_syllables, 'columns': json_columns, 'boards': json_boards, 'currentBoard': json_current_board};
